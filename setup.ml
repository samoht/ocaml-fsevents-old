...
(* OASIS_START *)
(* DO NOT EDIT (digest: 964fcd6d22f49320ce9466dc74fd2642) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Ctypes bindings to FSevents";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Fsevents"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "fsevents";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "b \140¶´|§\138A.Ós¶,¨\t";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
